...
int main()
{
  ...
  std::cout << "The test is conducted only on the motor with ID "
            << static_cast<int>(motor1->getID()) << std::endl;
  ...
  std::cout << "│Torque ON result: "
            << static_cast<int>(result_uint8_t.value()) << "     │" << std::endl;
